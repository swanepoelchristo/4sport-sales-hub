...
const DASHBOARD_TIME_ZONE = "Africa/Johannesburg";
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                          {t.ticket_number && (
                            <span className="rounded-full border border-cyan-200 bg-cyan-50 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-cyan-700">
                              {t.ticket_number}
                            </span>
                          )}
